...
- [Browser recording](references/docs-browser-recording.md) - Record browser sessions as Motion-JPEG AVI videos with optional agent captions.
- [Channels overview](references/docs-capabilities-channels.md) - Channels connect Mastra agents to messaging platforms like Slack, Discord, and Telegram.
...
- [Datasets overview](references/docs-datasets-overview.md) - Manage versioned test data, run experiments against agents and workflows, and track results over time.
...
- [Develop](references/docs-getting-started-develop.md) - Develop and test Mastra agents locally with the development server, Studio, and AI-assisted tools.
...
- [AgentController](references/docs-harness-agent-controller.md) - Build interactive agent applications with isolated sessions, persistent threads, modes, approvals, subagents, and channels.
- [Harness overview](references/docs-harness-overview.md) - Start, continue, update, and preserve agent work beyond a single request.
...
- [Workers](references/docs-server-auth-workers.md) - Secure communication between standalone workers and the Mastra API server.
...
- [Speech-to-Text (STT)](references/guides-voice-speech-to-text.md) - Overview of Speech-to-Text capabilities in Mastra, including configuration, usage, and integration with voice providers.
- [Text-to-Speech (TTS)](references/guides-voice-text-to-speech.md) - Overview of Text-to-Speech capabilities in Mastra, including configuration, usage, and integration with voice providers.

### Integrations

- [Integrations](references/integrations.md)
- [Using Assistant UI](references/integrations-agentic-ui-assistant-ui.md) - Learn how to integrate Assistant UI with Mastra
- [Using CopilotKit](references/integrations-agentic-ui-copilotkit.md) - Learn how to integrate CopilotKit with Mastra
- [Using OpenUI](references/integrations-agentic-ui-openui.md) - Learn how to integrate OpenUI with Mastra
...
- [Guide: Web scraping with Firecrawl](references/integrations-tools-firecrawl.md) - Use Firecrawl in Mastra tools to search, scrape, and extract web data.
