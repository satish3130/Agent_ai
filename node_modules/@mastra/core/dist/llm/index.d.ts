...
export { GatewayRegistry, PROVIDER_REGISTRY, parseModelString, getProviderConfig, modelSupportsAttachments, modelSupportsStructuredOutput, modelSupportsTemperature, } from './model/provider-registry.js';
...
}[Provider] | `mastra/${ProviderModelsMap['openrouter'][number]}` | (string & {});
...
export type { ProviderConfig, GatewayLanguageModel, MastraModelGatewayInterface, GatewayAuthRequest, GatewayAuthResult, } from './model/gateways/base.js';
...
export { resolveModelAuth, type ResolveModelAuthArgs } from './model/model-auth-resolver.js';
