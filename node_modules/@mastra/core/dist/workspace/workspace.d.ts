...
import type { BM25Config, TokenizeOptions, Embedder, SearchOptions, SearchResult } from './search/index.js';
 ...
 */
export type DynamicSandboxInstructions = 'placeholder' | 'resolve' | ((context: {
    requestContext: RequestContext;
}) => string);
/**
 ...
 */
export type WorkspaceSandboxCacheKey = (context: {
    requestContext: RequestContext;
}) => string | undefined;
/**
...
export declare class Workspace<TFilesystem extends WorkspaceFilesystem | undefined = WorkspaceFilesystem | undefined, TSandbox extends WorkspaceSandbox | undefined = WorkspaceSandbox | undefined, TMounts extends Record<string, WorkspaceFilesystem> | undefined = undefined> {
    ...
    private readonly _sandboxResolver?;
    private readonly _filesystemRequestCache;
    private readonly _sandboxRequestCache;
    private readonly _sandboxKeyCache;
    private readonly _sandboxCacheKey?;
    private readonly _dynamicSandboxInstructions;
    private readonly _browser?;
    private readonly _config;
    private readonly _searchEngine?;
    private _skills?;
    /** Set as soon as `destroy()` begins, and never cleared. */
    private _teardownStarted;
    private _lsp?;
    private _logger?;
