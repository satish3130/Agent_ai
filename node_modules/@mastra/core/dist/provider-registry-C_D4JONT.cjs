...
const require_dist = require("./dist-Bm-QHHba.cjs");
const require_gateway_helpers = require("./gateway-helpers-CdK-tcyA.cjs");
const require_models_dev = require("./models-dev-C28vVY3u.cjs");
const require_netlify = require("./netlify-CaAp_TNX.cjs");
let os = require("os");
...
var GatewayRegistry = class GatewayRegistry {
	...
	*/
	async syncGateways(forceRefresh = false, writeToSrc = false) {
		...
		try {
			const { ModelsDevGateway } = await Promise.resolve().then(() => require("./models-dev-C28vVY3u.cjs")).then((n) => n.models_dev_exports);
			const { NetlifyGateway } = await Promise.resolve().then(() => require("./netlify-CaAp_TNX.cjs")).then((n) => n.netlify_exports);
...
//# sourceMappingURL=provider-registry-C_D4JONT.cjs.map