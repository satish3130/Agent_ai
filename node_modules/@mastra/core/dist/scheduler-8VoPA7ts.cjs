...
*/
var Scheduler = class extends require_base.MastraBase {
	#schedulesStore;
	#pubsub;
	#config;
	#intervalHandle;
	...
	*/
	...
	async #fireSchedule(schedule) {
		...
		let newNextFireAt;
		try {
			newNextFireAt = require_cron.computeNextFireAt(schedule.cron, {
...
//# sourceMappingURL=scheduler-8VoPA7ts.cjs.map