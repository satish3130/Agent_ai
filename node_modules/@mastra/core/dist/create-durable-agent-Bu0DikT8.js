...
import { t as EventEmitterPubSub } from "./event-emitter-DG_kox_y.js";
import { t as CachingPubSub } from "./caching-pubsub-Dqo-0ayr.js";
import { i as createObservabilityContext } from "./observability-D0VC7bj2.js";
import { a as getOrCreateSpan, f as EntityType, o as getRootExportSpan, s as getStepAvailableToolNames } from "./utils-D4OpCtlK.js";
...
import { i as resolveModelConfig } from "./llm-BoEzOXnt.js";
import { toStandardSchema } from "./schema/index.js";
import { a as createBackgroundTask, i as resolveBackgroundConfig } from "./background-tasks-CgrsFq8r.js";
import { r as isMastraTool, t as getNeedsApprovalFn } from "./toolchecks-BsyK_wBH.js";
import { d as makeCoreTool, n as createMastraProxy, r as deepMerge } from "./utils-DFoDEOYy.js";
import { boundedStringify } from "./utils/safe-stringify.js";
import { b as isSupportedLanguageModel, c as safeClose, l as safeEnqueue, r as MastraModelOutput, t as TripWire, u as ProcessorRunner, y as createProcessorSendSignal } from "./trip-wire-BhUIouVi.js";
import { $n as stopGoalActivity, A as formatStreamCompletionFeedback, C as findProviderToolByName, D as mergeProviderOptions, E as PrepareStepProcessor, L as runStreamCompletionScorers, S as applyAutoResumeSystemMessage, T as execute, Xt as resolveDeclineReason, Zn as beginGoalActivity, Zt as createGoalScorer, _ as buildMemoryHeaders, a as AGENT_STREAM_TOPIC, b as composeStepInput, c as DurableAgentDefaults, g as buildMessagesFromChunks, h as endPendingProviderToolSpan, i as AGENT_CONTROL_TOPIC, kn as runScorer, l as DurableStepIds, m as normalizeToolCallConcurrency, n as runIdleLoop, o as AgentControlEventTypes, p as normalizeModelOutput, r as SaveQueueManager, s as AgentStreamEventTypes, sn as createWorkflow, t as Agent, v as mergeLlmCallHeaders, vn as createStep, w as inferProviderExecuted, x as buildLlmPromptArgs, y as injectBackgroundTaskPrompt, z as pruneAgentLoopSnapshot } from "./agent-B2LHedIt.js";
...
import { a as coreContentToString, n as MessageList, t as convertMessages } from "./message-list-CTjNC4HJ.js";
import { D as resolveEffectiveGoalSettings, E as readObjective, O as resolveGoalStore, b as GOAL_SCORER_ID, k as writeObjective } from "./task-state-processor-BSaCkdbB.js";
import { noopLogger } from "./logger/index.js";
import { PUBSUB_SYMBOL } from "./workflows/constants.js";
import { h as agentThreadStreamRuntime } from "./storage-4_LI2V5G.js";
...
async function prepareForDurableExecution(options) {
	...
	if (inputProcessors.length > 0) try {
		const { ProcessorRunner } = await import("./trip-wire-BhUIouVi.js").then((n) => n.f);
		await new ProcessorRunner({
			inputProcessors,
			outputProcessors,
			errorProcessors,
