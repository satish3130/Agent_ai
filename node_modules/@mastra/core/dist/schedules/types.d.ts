...
import type { AgentSignalActiveBehavior, AgentSignalIdleBehavior } from '../agent/types.js';
/**
...
export declare const AGENT_SCHEDULE_PREFIX = "agent_";
/**
 ...
 */
export declare const WORKFLOW_SCHEDULE_PREFIX = "schedule_";
/**
 ...
 */
export type ScheduleRunStatus = 'fired' | 'signal-accepted' | 'skipped-thread-blocked' | 'thread-missing' | 'agent-missing' | 'invalid-input';
/**
 ...
 */
export declare const SCHEDULE_SIGNAL_TYPES: readonly ["user", "state", "reactive", "notification", "user-message", "system-reminder"];
/** Lifecycle statuses a schedule row may be created with. */
export declare const SCHEDULE_STATUSES: readonly ["active", "paused"];
/**
 ...
 */
export declare const ScheduleInputSchema: z.ZodObject<{
...
export declare const ScheduleOutputSchema: z.ZodObject<{
    status: z.ZodEnum<{
        ...
        "skipped-thread-blocked": "skipped-thread-blocked";
...
export type ScheduleHooks<TMastra = unknown> = {
    prepare?: (ctx: SchedulePrepareContext<TMastra>) => Promise<SchedulePrepareResult | null | undefined> | SchedulePrepareResult | null | undefined;
