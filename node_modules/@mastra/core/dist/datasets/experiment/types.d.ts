...
import type { MastraScorer, ScorerStepName } from '../../evals/base.js';
import type { Mastra } from '../../mastra/index.js';
import type { VersionOverrides } from '../../mastra/types.js';
import type { DatasetTenancyFilters, ExperimentGrouping, ExperimentProvenance, ExperimentStatus, TargetType } from '../../storage/types.js';
import type { ExperimentEventObserver } from './events.js';
import type { ItemToolMock, ToolMockReport, UnmockedToolPolicy } from './tool-mocks.js';
/**
 ...
 */
export type StartExperimentConfig<I = unknown, O = unknown, E = unknown> = Omit<ExperimentConfig<I, O, E>, 'datasetId' | 'data' | 'experimentId' | 'filters'>;
/**
