...
export declare class InMemoryMemory extends MemoryStorage {
    readonly supportsPartialThreadUpdate: boolean;
    ...
    listMessagesByResourceId({ resourceId, include, filter, perPage: perPageInput, page, orderBy, }: StorageListMessagesByResourceIdInput): Promise<StorageListMessagesOutput>;
