...
export declare const INPUT_PREVIEW_MAX_LENGTH = 100;
/**
 ...
 */
export declare function buildInputPreview(input: unknown, maxLength?: number): string | undefined;
/**
 ...
 */
export declare function toLightSpanRecord(span: SpanRecord): LightSpanRecord;
/**
...
export declare const lightSpanRecordSchema: z.ZodObject<{
    ...
    endedAt: z.ZodOptional<z.ZodNullable<z.ZodDate>>;
    error: z.ZodOptional<z.ZodNullable<z.ZodUnknown>>;
    status: z.ZodOptional<z.ZodNullable<z.ZodEnum<typeof TraceStatus>>>;
    entityType: z.ZodOptional<z.ZodNullable<z.ZodEnum<typeof import("../../../_types/@internal_core/dist/storage/index.d.ts").EntityType>>>;
    entityId: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    entityName: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    metadata: z.ZodOptional<z.ZodNullable<z.ZodRecord<z.ZodString, z.ZodUnknown>>>;
    inputPreview: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    traceId: z.ZodString;
    spanId: z.ZodString;
}, z.core.$strip>;
 ...
 */
export declare const BRANCH_SPAN_TYPES: readonly [SpanType.AGENT_RUN, SpanType.WORKFLOW_RUN, SpanType.PROCESSOR_RUN, SpanType.SCORER_RUN, SpanType.RAG_INGESTION, SpanType.TOOL_CALL, SpanType.MCP_TOOL_CALL, SpanType.PROVIDER_TOOL_CALL];
