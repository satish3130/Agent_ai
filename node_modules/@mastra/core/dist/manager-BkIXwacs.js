...
import { a as resolveObservabilityContext } from "./observability-D0VC7bj2.js";
import { f as EntityType } from "./utils-D4OpCtlK.js";
import { a as RequestContext, n as MASTRA_RESOURCE_ID_KEY } from "./request-context-p_Tq-4EM.js";
import { t as deepEqual } from "./deep-equal-CQ4o_vUw.js";
import { b as isSupportedLanguageModel } from "./trip-wire-BhUIouVi.js";
import { en as validateAndSaveScore, nn as ScorerRunError } from "./agent-B2LHedIt.js";
import { _n as extractTrajectoryFromTrace, gn as extractTrajectory } from "./constants-DHeqmMxX.js";
...
async function executeAgent(agent, item, signal, requestContext, experimentId, versions, toolMocks, unmockedToolPolicy) {
	...
	const memoryOption = Boolean(contextResourceId) && !requestContext?.["mastra__threadId"] && typeof agent.hasOwnMemory === "function" && agent.hasOwnMemory() ? { memory: {
		thread: {
			id: randomUUID(),
...
//# sourceMappingURL=manager-BkIXwacs.js.map