...
const require_caching_pubsub = require("./caching-pubsub-B_HXtJR8.cjs");
const require_observability = require("./observability-DROw5MeE.cjs");
const require_utils = require("./utils-3CXfRmFo.cjs");
...
const require_toolchecks = require("./toolchecks-1VHxz831.cjs");
const require_utils$1 = require("./utils-CIpRjNDm.cjs");
...
const require_message_list = require("./message-list-CfU8WFTQ.cjs");
const require_task_state_processor = require("./task-state-processor-pw6U-sWJ.cjs");
const require_logger_index = require("./logger/index.cjs");
const require_workflows_constants = require("./workflows/constants.cjs");
const require_storage = require("./storage-BUuNlD1C.cjs");
...
async function prepareForDurableExecution(options) {
	...
	if (inputProcessors.length > 0) try {
		const { ProcessorRunner } = await Promise.resolve().then(() => require("./trip-wire-CQjAIWxm.cjs")).then((n) => n.runner_exports);
			...
			if (requiresApproval && resumeData && typeof resumeData === "object" && resumeData !== null && "approved" in resumeData) {
				...
				if (!resumeData.approved) {
					const approval = {
						id: toolCallId,
						approved: false,
						reason: require_agent.resolveDeclineReason(resumeData)
					};
					if (pubsub) try {
...
//# sourceMappingURL=create-durable-agent-Y0is--nG.cjs.map